...
<div class="modal-header">
    <h4 class="modal-title"><?= $action ?> Media</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<form id="formTambahMedia">

    <div class="modal-body">
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Input Media</h3>
            </div>
                    ...
                    ?>
                        <?php if ($kolom->type == "FILE"): ?>
                            <div class="col-md-12 mb-3">
                                <label for="<?= $val ?>"><?= $kolom->name ?></label>
...
<script>
    $(document).ready(function() {
        ...
        $('#formTambahMedia').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "<?= base_url('Dashboard/save_Media/') ?>" + action,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
